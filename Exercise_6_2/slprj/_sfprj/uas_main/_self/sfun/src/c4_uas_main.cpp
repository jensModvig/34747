...
static void initialize_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void initialize_params_c4_uas_main(SFc4_uas_mainInstanceStruct
  *chartInstance);
static void mdl_start_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void mdl_terminate_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void mdl_setup_runtime_resources_c4_uas_main(SFc4_uas_mainInstanceStruct *
  chartInstance);
static void mdl_cleanup_runtime_resources_c4_uas_main
  (SFc4_uas_mainInstanceStruct *chartInstance);
static void enable_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void disable_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void sf_gateway_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void ext_mode_exec_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void c4_update_jit_animation_c4_uas_main(SFc4_uas_mainInstanceStruct
  *chartInstance);
static void c4_do_animation_call_c4_uas_main(SFc4_uas_mainInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_uas_main(SFc4_uas_mainInstanceStruct
  *chartInstance);
static void set_sim_state_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void initSimStructsc4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance);
static void initSubchartIOPointersc4_uas_main(SFc4_uas_mainInstanceStruct
  *chartInstance);
static real_T c4_function_handle_parenReference(SFc4_uas_mainInstanceStruct
  *chartInstance, real_T c4_varargin_1, real_T c4_varargin_2);
static void c4_expand_atan2(SFc4_uas_mainInstanceStruct *chartInstance, real_T
  c4_a_data[], int32_T c4_a_size[3], real_T c4_b_data[], int32_T c4_b_size[3],
  real_T c4_c_data[], int32_T c4_c_size[3]);
static real_T c4_emlrt_marshallIn(SFc4_uas_mainInstanceStruct *chartInstance,
  const mxArray *c4_b_pitch, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_uas_mainInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static uint8_T c4_c_emlrt_marshallIn(SFc4_uas_mainInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_uas_main, const char_T *c4_identifier);
static uint8_T c4_d_emlrt_marshallIn(SFc4_uas_mainInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_slStringInitializeDynamicBuffers(SFc4_uas_mainInstanceStruct
  *chartInstance);
static void c4_chart_data_browse_helper(SFc4_uas_mainInstanceStruct
  *chartInstance, int32_T c4_ssIdNumber, const mxArray **c4_mxData, uint8_T
  *c4_isValueTooBig);
static void init_dsm_address_info(SFc4_uas_mainInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_uas_mainInstanceStruct *chartInstance);
...
static void initialize_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_uas_main = 0U;
}
...
static void sf_gateway_c4_uas_main(SFc4_uas_mainInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c4_roll = c4_d;
  c4_do_animation_call_c4_uas_main(chartInstance);
  ...
  *chartInstance)
{
  ...
  sf_mex_assign(&c4_e_y, sf_mex_create("y",
    &chartInstance->c4_is_active_c4_uas_main, 3, 0U, 0U, 0U, 0), false);
  ...
  const mxArray *c4_st)
{
  ...
  *chartInstance->c4_roll = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_uas_main = c4_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 2)), "is_active_c4_uas_main");
  sf_mex_destroy(&c4_u);
...
const mxArray *sf_c4_uas_main_get_eml_resolved_functions_info()
{
  ...
  const mxArray *c4_b_is_active_c4_uas_main, const char_T *c4_identifier)
{
  ...
  c4_y = c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_uas_main), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_uas_main);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_uas_main_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_uas_main_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_uas_main_jit_fallback_info(void)
{
...
mxArray *sf_c4_uas_main_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_uas_main(void)
{
  ...
  mxArray *mxVarInfo = sf_mex_decode(
    ...
    "D+MCDgDxYUf7AwFOXn5FDH/QoOlOmH2O9BwP2iaPEA4mcWxycml2SWpcYnm8SXJhbH5yZm5iHFC"
    "wCR/B45"
    );
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_uas_main_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c4_uas_main(void *chartInstanceVar)
{
  initialize_params_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
  initialize_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_uas_main(void *chartInstanceVar)
{
  enable_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_uas_main(void *chartInstanceVar)
{
  disable_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_uas_main(void *chartInstanceVar)
{
  sf_gateway_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_uas_main(SimStruct* S)
{
  return get_sim_state_c4_uas_main((SFc4_uas_mainInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_uas_main(SimStruct* S, const mxArray *st)
{
  set_sim_state_c4_uas_main((SFc4_uas_mainInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_cleanup_runtime_resources_c4_uas_main(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_uas_mainInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_uas_main_optimization_info();
    }

    mdl_cleanup_runtime_resources_c4_uas_main((SFc4_uas_mainInstanceStruct*)
      chartInstanceVar);
    ((SFc4_uas_mainInstanceStruct*) chartInstanceVar)->
      ~SFc4_uas_mainInstanceStruct();
...
static void sf_opaque_mdl_start_c4_uas_main(void *chartInstanceVar)
{
  mdl_start_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
  if (chartInstanceVar) {
    sf_reset_warnings_ChartRunTimeInfo(((SFc4_uas_mainInstanceStruct*)
      chartInstanceVar)->S);
  }
}

static void sf_opaque_mdl_terminate_c4_uas_main(void *chartInstanceVar)
{
  mdl_terminate_c4_uas_main((SFc4_uas_mainInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_uas_main(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_uas_main((SFc4_uas_mainInstanceStruct*)
      sf_get_chart_instance_ptr(S));
    initSubchartIOPointersc4_uas_main((SFc4_uas_mainInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

const char* sf_c4_uas_main_get_post_codegen_info(void)
{
  int i;
  const char* encStrCodegen [22] = {
    "eNrtWNtuG0UYHrtpRNUSekGFhJCokJB6g0RDkVoJlSQ+tJbsJrBOQL2JJru/vSPPzmznYMeIh0D",
    "iRbjkhtdAiKfgkkv+WW9cZ2OcmQTSFrHRejO7+/2n+Y9Lap0ewWMDz6fvE7KO17fwrJPZcb1c1x",
    "bO2f018kW5/v4mIbFMYAgisoMBOyZhh7DZHlU00yT8EDSDr0FLbg2ToiMG0h/LxAAUiBgJ5FKZI",
    "L6aZZYzMWpbETvO+puUxWmUSsuTHSRIk13Bp3/HN7dmDzk2mYLYtAESkypph2mb0+FqKygzaaQQ",
    "j7TNgm2lwUQ2d6rqnuWG5RxaxxB3hDYUraDP0Tcy1EDDHIcZ2emroxO0zHLOqPC3dUp1BDl6h4H",
    "9PMHfXWvQel7YOKXK7EBKx6C7bFRwlwK8uDONbx8xQY1UjPJWxhuOmqe+exx17GFI8NA9Qn13FN",
    "BRLpkwgQERtdHOLUGPODThyA4D+UbwwrpoOGAwARW2v4OGHIOiQ9gVYTIXe9Q6LpxyHkueWMMyO",
    "KBqO0bf1ZCE5Q0MOh1RdEfoI5kgLBQm7ui+YmP0jdBc13Hhf6FcZ7OZ9+sLYQu+rTEE+9WcbzsW",
    "Dcq5DsP2Zd6FMfCCf5MaegHsjH8AWGuW9CV6h8s2gRnLCoaRUGIbUiTM3yvHFVRR2J5hkfKAs8y",
    "FASRo5rnoc0LnxZHVRmYNTDnNbteT31lsRxhQAxqDd41RlGlAgQu/CuSbMO0CCdFoJVNo6U1hFo",
    "MXghI9sKI5kWqENg4tZi9t5SIhDA3JEBOzgSLJtdC7Dyi3njJneojxg+6xrzHLhvFFrIufC4FjG",
    "qeQuMrJOPQwzyIB3y3WruRvo7ZjZqZN0LFiuW8kWUzoWHSdlfrTHPbFSMiJaCuZRWXntcKvADBr",
    "UCWYGO5gCVfTNgrvJ7WCF/0iu4c2Oc7O1HB65HzjCQishk5X1zXQGKOqJbBFRoEug43Yd9jECM2",
    "0wUI9nZX6Wd1z/fsWedm/ry3p328u9O+3y3X84NBSfZhRJuZ0Pl2gc8tjDvDBkTM4MsedXO8t4G",
    "tL+JKFa5Xfjfrp9+sVfnX8q9XO2untCp+1Cm69tNXvH3/1qPbDj/ce/5r+8tM7je55/Gtn+NeK/",
    "x0uvRY2Z22U6w9O+qV5dh6fSWDFHHeOH7xX8QO31gI2uw8i0+k9Tx6KfHh8/9m3Tx89Kej9XF8t",
    "77WKvCf377oeDYO3yAUq7iTlvObW1M7mCEf/4YK86+fY48aCPxHyx5eXw3+0VcUvs9f1ir3cOmc",
    "mTiv+++r0eHer6o/L9Fg7pccaUZLzf0b+u1uXw/v57Z3KPtwpZo9D6ioMHJ7OZBueeWJVnIbiyB",
    "Xj3hQ5/7fLv6+fT52uXzGOXDHusvqF9h9v+vur6gWpvH/7NdaDrMj3IX3o66bXbySsT/ywXD+ef",
    "/9opIwnSyaw8jEOSYNlT/8j/v1noP1O+uKWs1/5ofz5Z9uC8imOXLORtry9p9z3zvkjBVQvn2tf",
    "RT3xnQdvVeLbrSdMJHKiP7m/+fnmZerTX2u4GXg=",
    ""
  };
...
static void mdlSetWorkWidths_c4_uas_main(SimStruct *S)
{
  const char* newstr = sf_c4_uas_main_get_post_codegen_info();
...
static void mdlRTW_c4_uas_main(SimStruct *S)
{
...
static void mdlSetupRuntimeResources_c4_uas_main(SimStruct *S)
{
  SFc4_uas_mainInstanceStruct *chartInstance;
  chartInstance = (SFc4_uas_mainInstanceStruct *)utMalloc(sizeof
    (SFc4_uas_mainInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc4_uas_mainInstanceStruct));
  chartInstance = new (chartInstance) SFc4_uas_mainInstanceStruct;
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_uas_main;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_uas_main;
  chartInstance->chartInfo.mdlStart = sf_opaque_mdl_start_c4_uas_main;
  chartInstance->chartInfo.mdlTerminate = sf_opaque_mdl_terminate_c4_uas_main;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c4_uas_main;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_uas_main;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_uas_main;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_uas_main;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_uas_main;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_uas_main;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_uas_main;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_uas_main;
  ...
  mdl_setup_runtime_resources_c4_uas_main(chartInstance);
}

void c4_uas_main_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c4_uas_main(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_uas_main(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_uas_main(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_uas_main_method_dispatcher.\n"
